...
function CakeCards({cake, onAddReview, onDeleteCake}){
...
return(
    <div className="card">
        ...
        {show? <ReviewCard cake={cake} cake_reviews={cake.reviews} onAddReview={onAddReview} onDeleteCake={onDeleteCake}/> : null}
    </div>
